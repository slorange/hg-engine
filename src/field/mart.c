...
u16 sGoldenrodDepartmentLower2F[] = {
    ITEM_POKE_BALL, ITEM_GREAT_BALL, ITEM_ULTRA_BALL, ITEM_ESCAPE_ROPE, ITEM_POKE_DOLL, ITEM_REPEL, ITEM_SUPER_REPEL, ITEM_MAX_REPEL, ITEM_CHILAN_BERRY, ITEM_SILK_SCARF, ITEM_GRIP_CLAW, ITEM_STICKY_BARB, ITEM_SHED_SHELL, 0xFFFF
};
...
u16 sCeladonDepartment4F[] = {
    ITEM_SUN_STONE, ITEM_LEAF_STONE, ITEM_RINDO_BERRY, ITEM_MIRACLE_SEED, ITEM_GRIP_CLAW, ITEM_STICKY_BARB, ITEM_SHED_SHELL, 0xFFFF
};
