#!/usr/bin/env python3
"""Patch Route 31 → Route 45 Dark Cave ferry script into scr_seq member 230."""
...
PATCH_SOURCES = [
    (ROOT / "armips/scr_seq/scr_seq_r31_ferry_r45.s", ROOT / "build/r31_ferry_r45.bin"),
]
...
def main(argv: list[str]) -> int:
    if len(argv) != 2:
        print(f"usage: {argv[0]} <build/a012/2_230>", file=sys.stderr)
        return 1
    ...
    print(
        "Route 31 ferry script patched into "
