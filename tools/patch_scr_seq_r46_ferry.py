#!/usr/bin/env python3
"""Patch Route 46 → Route 45 ferry script into scr_seq member 259."""
...
PATCH_SOURCES = [
    (ROOT / "armips/scr_seq/scr_seq_r46_ferry_r45.s", ROOT / "build/r46_ferry_r45.bin"),
]
...
def main(argv: list[str]) -> int:
    if len(argv) != 2:
        print(f"usage: {argv[0]} <build/a012/2_259>", file=sys.stderr)
        return 1
    ...
    print(
        "Route 46 ferry script patched into "
