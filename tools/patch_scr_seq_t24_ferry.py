#!/usr/bin/env python3
"""Patch Cianwood → Route 40 ferry script into scr_seq member 875."""
...
PATCH_SOURCES = [
    (ROOT / "armips/scr_seq/scr_seq_t24_ferry_route40.s", ROOT / "build/t24_ferry_route40.bin"),
]

VANILLA_SCRIPT_COUNT = 16
FERRY_SLOT = 16
...
def main(argv: list[str]) -> int:
    if len(argv) != 2:
        print(f"usage: {argv[0]} <build/a012/2_875>", file=sys.stderr)
        return 1
    ...
    print(
        "Cianwood ferry script patched into "
