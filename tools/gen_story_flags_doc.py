...
WANDERING_HEART_NOTES: dict[int, str] = {
    ...
    123: "Mom intro: `setflag` Azalea Rockets beaten; `clearflag` 625 harassing, `setflag` 626 harassed (`openworld_story_skip_flags.inc`).",
    ...
    197: "Mahogany Rocket skip: `clearflag` (Mom intro + `scr_seq_t28_005_patch.s` if starting items off).",
    198: "Mahogany Rocket skip: `setflag` beat radio tower (Mom intro; OnLoad full patch if starting items off).",
    201: "Mahogany skip: **do not set** — keeps Red Gyarados chain (HACK-NOTES).",
    202: "Mahogany Rocket skip: `setflag` hideout cleared (Mom intro; OnLoad full patch if starting items off).",
    210: "Pryce gym patch: TM07 reward `setflag`.",
    235: "Mom intro: `FLAG_BOAT_ARRIVED` — SS Aqua post-first-voyage (pret).",
    242: "Mom intro: `FLAG_UNK_0F2` / pret `GOT_SS_TICKET_FROM_ELM` (S.S. Ticket item also from Mom).",
    ...
    369: "Mahogany Rocket skip + Mom intro: `setflag` → Mahogany good mart stock.",
