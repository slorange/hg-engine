#!/usr/bin/env python3
"""Patch Route 45 → Route 31 Dark Cave ferry script into scr_seq member 258."""
...
PATCH_SOURCES = [
    (ROOT / "armips/scr_seq/scr_seq_r45_ferry_r31.s", ROOT / "build/r45_ferry_r31.bin"),
]

VANILLA_SCRIPT_COUNT = 5
FERRY_SLOT = 5
...
def main(argv: list[str]) -> int:
    if len(argv) != 2:
        print(f"usage: {argv[0]} <build/a012/2_258>", file=sys.stderr)
        return 1
    ...
    print(
        "Route 45 ferry script patched into "
