#!/usr/bin/env python3
"""Patch Route 40 → Cianwood ferry script into scr_seq member 962."""
...
PATCH_SOURCES = [
    (ROOT / "armips/scr_seq/scr_seq_w40_ferry_cianwood.s", ROOT / "build/w40_ferry_cianwood.bin"),
]

VANILLA_SCRIPT_COUNT = 10
FERRY_SLOT = 10
...
def main(argv: list[str]) -> int:
    if len(argv) != 2:
        print(f"usage: {argv[0]} <build/a012/2_962>", file=sys.stderr)
        return 1
    ...
    print(
        "Route 40 ferry script patched into "
