...
When a script becomes reusable (referenced from `documentation/HACK-NOTES.md` / `documentation/AGENTS.md` or wired into `Makefile` / `narcs.mk`), move it to `scripts/dev/` or `scripts/build/`.
...
See `documentation/AGENTS.md` § **Scripts layout**.
