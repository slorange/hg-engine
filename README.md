> This README is the original hg-engine guide. For **Pokémon Wandering Heart** — design, status, and what’s shipped — see [`DESIGN.md`](DESIGN.md) and [`CHANGELOG.md`](CHANGELOG.md).
...
1. Add `BluRosie/hg-engine` as an `upstream` source so you can pull changes

```
git remote add upstream https://github.com/BluRosie/hg-engine.git
```

1. Continue to [Build Instructions](#build-instructions-all-platforms-continued-from-further-setup-instructions)
...
This is generally **not** recommended because you can easily lose your progress if WSL has issues, and you will
...
If the CLI indicates merge conflicts, check [this article](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/addressing-merge-conflicts/resolving-a-merge-conflict-using-the-command-line) for how to navigate them.

# Credits

- [CREDITS.md](CREDITS.md).
- **[Bubble (Base Mega Code)](https://github.com/Bubble791/Pokemon-Heart-Gold-Engine)**
- **[Skeli (FR template)](https://github.com/Skeli789/Complete-Fire-Red-Upgrade)**
- **[PokeDiamond decompilation projects (nitrogfx, msgenc)](https://github.com/pret/pokediamond)**
- **[Mikelan98, Nomura (ARM9 Expansion Subroutine )](https://pokehacking.com/tutorials/ramexpansion/)**
